...
# settings = Settings()
helper_file_path = Path(__file__).resolve()
root_folder = helper_file_path.parents[2]




LOCALHOST_SEED_URL =  "http://localhost:"
# LOCALHOST_SEED_URL = os.environ.get("LOCALHOST_SEED_URL")
PORT = "8000"
...
DATA_FILE_PATH = str(root_folder/"app"/"data"/"df_indianRecipes.pkl")
BLANK_IMAGE_PATH = str(root_folder/"app"/"data"/"blank_image.jpg")
